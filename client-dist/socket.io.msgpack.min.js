  ...
  return (function (t) {
    ...
    function (t, e, n) {
      ...
      (u.prototype.encode = function (t) {
        ...
        (f.prototype.checkPacket = function (t) {
          if (!(s(t.type) && t.type >= i.CONNECT && t.type <= i.CONNECT_ERROR))
          ...
          if (
            !(function (t) {
              switch (t.type) {
                case i.CONNECT:
                  return void 0 === t.data || c(t.data);
                case i.DISCONNECT:
                  return void 0 === t.data;
                case i.CONNECT_ERROR:
                  return a(t.data) || c(t.data);
                default:
            ...
            (n = [
              ...
              },
              {
                ...
                value: function (t, e) {
                  var n = this.nsps[t];
                  return (
                    n || ((n = new h.Socket(this, t, e)), (this.nsps[t] = n)), n
                  );
                },
              },
              {
          ...
          return (
            ...
            (n = [
              ...
              },
              {
                ...
                value: function (t) {
                  this.connected ||
                    a(h(f.prototype), "emit", this).call(
                      this,
                      "connect_error",
                      t
                    );
              ...
              },
              {
                ...
                value: function (t) {
                  (this.connected = !1),
                    (this.disconnected = !0),
                    delete this.id,
                    a(h(f.prototype), "emit", this).call(this, "disconnect", t);
                },
              },
              {
                key: "onpacket",
              ...
              },
              {
                ...
                value: function (t) {
                  ...
                  a(h(f.prototype), "emit", this).apply(this, t);
                },
              },
              {
                key: "ack",
              ...
              },
              {
                ...
                value: function (t) {
                  (this.id = t),
                    (this.connected = !0),
                    (this.disconnected = !1),
                    a(h(f.prototype), "emit", this).call(this, "connect"),
                    this.emitBuffered();
                },
              },
              {
      ...
      function c(t, e) {
        ...
        return (
          e.forceNew || e["force new connection"] || !1 === e.multiplex || h
            ? (n = new i.Manager(c, e))
            : (a[u] || (a[u] = new i.Manager(c, e)), (n = a[u])),
    ...
    function (t, e, n) {
      ...
      var l = n(9),
        ...
        b = n(2);
      function m() {}
      var g = null != new l({ xdomain: !1 }).responseType,
        _ = (function (t) {
          c(n, t);
          var e = f(n);
          function n(t) {
    ...
    function (t, e, n) {
      var r,
        ...
        s = o.ERROR_PACKET;
      "function" == typeof ArrayBuffer && (r = n(24));
      var a = function (t, e) {
          if (r) {
            var n = r.decode(t);
            return c(n, e);
      ...
      var b = (function (t) {
        ...
        function p(t) {
          ...
          !(function (t, e) {
            ...
            ((e = c.call(this, t)).query = e.query || {}),
            h || (h = l.___eio = l.___eio || []),
            (e.index = h.length);
          var n = u(e);
          return (
            h.push(function (t) {
            ...
            (n = [
              ...
              },
              {
                ...
                value: function () {
                  return !(
                    !d ||
                    ("__initialize" in d && this.name === c.prototype.name)
                  );
                },
              },
              {
    ...
    function (t, e, n) {
      ...
      t.exports = function (t) {
          ...
          i = (function t(e, n, o) {
            ...
            if ("string" === i) {
              if (
                ...
                e.push(160 | f), (h = 1);
              else if (f < 256) e.push(217, f), (h = 2);
              else if (f < 65536) e.push(218, f >> 8, f), (h = 3);
              else {
                if (!(f < 4294967296)) throw new Error("String too long");
                e.push(219, f >> 24, f >> 16, f >> 8, f), (h = 5);
              }
              return n.push({ _str: o, _length: f, _offset: e.length }), h + f;
            }
            if ("number" === i)
              return Math.floor(o) === o && isFinite(o)
                ? o >= 0
                  ? o < 128
                    ? (e.push(o), 1)
                    : o < 256
                  ...
                  ? (e.push(209, o >> 8, o), 3)
                  : o >= -2147483648
                  ? (e.push(210, o >> 24, o >> 16, o >> 8, o), 5)
                  : ((c = Math.floor(o / Math.pow(2, 32))),
                    (u = o >>> 0),
                    e.push(
                      211,
                      c >> 24,
                    ...
                    9)
                : (e.push(203),
                  n.push({ _float: o, _length: 8, _offset: e.length }),
                  9);
            if ("object" === i) {
              if (null === o) return e.push(192), 1;
              if (Array.isArray(o)) {
                if ((f = o.length) < 16) e.push(144 | f), (h = 1);
                else if (f < 65536) e.push(220, f >> 8, f), (h = 3);
                else {
                  if (!(f < 4294967296)) throw new Error("Array too large");
                  e.push(221, f >> 24, f >> 16, f >> 8, f), (h = 5);
                }
                for (s = 0; s < f; s++) h += t(e, n, o[s]);
                return h;
              }
              if (o instanceof Date) {
                var p = o.getTime();
                return (
                  (c = Math.floor(p / Math.pow(2, 32))),
                  (u = p >>> 0),
                  e.push(
                    215,
                    0,
              ...
              if (o instanceof ArrayBuffer) {
                if ((f = o.byteLength) < 256) e.push(196, f), (h = 2);
                else if (f < 65536) e.push(197, f >> 8, f), (h = 3);
                else {
                  if (!(f < 4294967296)) throw new Error("Buffer too large");
                  e.push(198, f >> 24, f >> 16, f >> 8, f), (h = 5);
                }
                return (
                  n.push({ _bin: o, _length: f, _offset: e.length }), h + f
                );
              }
              ...
              if ((f = l.length) < 16) e.push(128 | f), (h = 1);
              else if (f < 65536) e.push(222, f >> 8, f), (h = 3);
              else {
        ...
        for (var h, p = 0, l = 0, y = 0, d = e.length; y < d; y++)
          if ((a.setUint8(u + y, e[y]), y + 1 === f)) {
            if (((p = (h = n[c])._length), (l = u + f), h._bin))
              for (var v = new Uint8Array(h._bin), b = 0; b < p; b++)
                a.setUint8(l + b, v[b]);
            else
              h._str
                ? o(a, l, h._str)
                : void 0 !== h._float && a.setFloat64(l, h._float);
            (u += p), n[++c] && (f = n[c]._offset);
          }
        return s;
      };
    },
      ...
      (r.prototype._array = function (t) {
        ...
        (r.prototype._parse = function () {
          ...
          switch (e) {
            ...
            case 204:
              return (
                (t = this._view.getUint8(this._offset)), (this._offset += 1), t
              );
            case 205:
              return (
                (t = this._view.getUint16(this._offset)), (this._offset += 2), t
              );
            case 206:
              return (
                (t = this._view.getUint32(this._offset)), (this._offset += 4), t
              );
            case 207:
              return (
                (o = this._view.getUint32(this._offset) * Math.pow(2, 32)),
            ...
            case 208:
              return (
                (t = this._view.getInt8(this._offset)), (this._offset += 1), t
              );
            case 209:
              return (
                (t = this._view.getInt16(this._offset)), (this._offset += 2), t
              );
            case 210:
              return (
                (t = this._view.getInt32(this._offset)), (this._offset += 4), t
              );
            case 211:
              return (
                (o = this._view.getInt32(this._offset) * Math.pow(2, 32)),
                (i = this._view.getUint32(this._offset + 4)),
                (this._offset += 8),
                o + i
              );
